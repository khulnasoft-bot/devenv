...
- Try esbuild @unified-dev packages to reduce `.vsix` size.
...
- (#1986) Remove `formatOnSave:false` in dev configuration.
...
Let's welcome @jabooth who joins the development of Dev Workshop!
