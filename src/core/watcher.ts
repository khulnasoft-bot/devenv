...
class Watcher {
    ...
    private async initiatePolling(uri: vscode.Uri): Promise<void> {
        ...
        }, vscode.workspace.getConfiguration('dev-workshop').get('dev.watch.pdf.delay') as number)
    }
    ...
    private async onDidDelete(uri: vscode.Uri): Promise<void> {
        ...
        return new Promise(resolve => {
            setTimeout(async () => {
                ...
                resolve()
            }, vscode.workspace.getConfiguration('dev-workshop').get('dev.watch.delay') as number)
        })
    }
