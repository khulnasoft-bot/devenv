...
/**
 * Builds a tree structure of Dev macros and environments in the given
 * document.
 *
 * Parses the Dev content in the document and constructs a tree structure of
 ...
 * (AST) of the Dev content.
 *
 * @param document - The vscode.TextDocument object representing the Dev
 * document.
 ...
 * identifies different types of Dev elements (environments, display math,
 * inline math, macros) and creates MacroPair objects accordingly.
 *
 * @param doc - The vscode.TextDocument object representing the Dev document.
 ...
 * current position.
 *
 * Consider the following Dev content
 *
 *  \ifpoo
 *      ....
 *  \else
...
async function goto() {
    ...
    if (!editor || editor.document.languageId !== 'dev') {
        return
    }
