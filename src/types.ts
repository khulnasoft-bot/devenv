...
export type FileCache = {
    ...
    /** The sub-files of the Dev file. They should be tex or plain files */
    children: {
    ...
    /** The array of the paths of `.bib` files referenced from the Dev file */
    bibfiles: Set<string>,
    ...
    /** The AST of this file, generated by unified-dev */
    ast?: Ast.Root
}
