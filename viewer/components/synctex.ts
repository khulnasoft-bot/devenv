import type { SynctexData, SynctexRangeData } from '../../types/dev-workshop-protocol-types/index.js'
...
function callSynctex(e: MouseEvent, page: number, pageDom: HTMLElement, viewerContainer: HTMLElement) {
    ...
    // workaround for https://github.com/khulnasoft/devenv/issues/1314
...
function forwardSynctexCirc(data: SynctexData) {
    ...
    // https://github.com/khulnasoft/devenv/pull/417
