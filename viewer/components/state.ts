...
import type { PanelManagerResponse, PdfViewerParams, PdfViewerState } from '../../types/dev-workshop-protocol-types/index.js'
...
export function initUploadState() {
    window.addEventListener('message', (e) => {
        ...
        if (!data.type) {
            console.log('DevEnvPdfViewer received a message of unknown type: ' + JSON.stringify(data))
            return
        }
        switch (data.type) {
            case 'restore_state': {
